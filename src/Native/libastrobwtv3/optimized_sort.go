...
var pooldata2 = sync.Pool{New: func() interface{} { return &Data2{} }}
...
// basically
func sort_indices2(N int, input_extra []byte, output []uint32, d *Data2) {
	...
	*/
	...
	for i := 0; i < N; i++ {
		output[i] = uint32(indices[i] & ((1 << 21) - 1))
	}
