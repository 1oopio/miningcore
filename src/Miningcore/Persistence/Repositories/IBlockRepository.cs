...
public interface IBlockRepository
{
    ...
    Task<uint> GetPendingBlocksForPoolCountAsync(IDbConnection con, string poolId, CancellationToken ct);
    ...
    Task<Block[]> GetPaymentStatusReadyBlocks(IDbConnection con, string poolId, uint limit, CancellationToken ct);
}
